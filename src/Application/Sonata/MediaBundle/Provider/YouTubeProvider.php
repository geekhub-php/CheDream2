...
use Sonata\MediaBundle\Provider\YouTubeProvider as VendorYouTubeProvider;

class YouTubeProvider extends VendorYouTubeProvider
{
    /**
     * {@inheritdoc}
     */
    public function getHelperProperties(MediaInterface $media, $format, $options = array())
    {
        ...
        $player_parameters = array_merge($default_player_parameters, array(
            'width' => $box->getWidth(),
            'height' => $box->getHeight()
            ),
            isset($options['player_parameters']) ? $options['player_parameters'] : array()
        );
