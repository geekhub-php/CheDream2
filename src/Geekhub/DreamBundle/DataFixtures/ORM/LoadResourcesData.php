...
class LoadResourcesData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    {
        $financeArray = $this->getFile(__DIR__.'/Data/Financial.yml');
    ...
    {
        $equipmentArray = $this->getFile(__DIR__.'/Data/Equipment.yml');
    ...
    {
        $workArray = $this->getFile(__DIR__.'/Data/Work.yml');
